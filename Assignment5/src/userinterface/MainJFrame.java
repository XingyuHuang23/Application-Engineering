...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public MainJFrame() {
        initComponents();
       // dB4OUtil.createNewSystem(); //搞一个全新的system
        system = dB4OUtil.retrieveSystem();   //初始化 ecoSystem,具体见configureASystem中
        this.setSize(1680, 1050);
        //dB4OUtil.storeSystem(system);  //持久化当前system
    }
    ...
    private void logoutJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutJButtonActionPerformed
        ...
        dB4OUtil.storeSystem(system); //登出时持久化数据，类似存档
